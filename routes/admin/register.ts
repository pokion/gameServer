...
import { AdminRequestRegister } from "../../types/apiRequest.js";

export default async (req: Request, res: Response) =>{
    try{
        const { email, login, password, pin }: AdminRequestRegister = typia.assert<AdminRequestRegister>(req.body);
        ...
        const result = await db.admin.add(email, login, hash, pin);
